...
export const Mainpage = () => {
    ...
    { img: art, title: "도자기 체험", discount: "10%", originp: "20000", discountp: "18000", link: "/onedayclass/0" },
    { img: coock, title: "인기요리교실", discount: "10%", originp: "30000", discountp: "27000", link: "/onedayclass/0" },
    { img: drawing, title: "솜씨그림교실", discount: "10%", originp: "40000", discountp: "36000", link: "/onedayclass/1" },
    { img: coffee, title: "바리스타체험", discount: "10%", originp: "50000", discountp: "45000" },
    { img: coffee2, title: "인기바리스타체험교실", discount: "10%", originp: "60000", discountp: "54000" }
]);
    ...
    // 씨발 
    // 로그인후, 홈버튼을 누르면 라우터 "/" url을 타는데
    // props를 전달할 방법 자체가 없어서 그냥 
    // login 컴포넌트에서 저장한 로컬저장소를 사용한다음
    // "/" url 요청시 로그인이냐 비로그인 이냐 판단하고
    // 강제로 iscookie={true} 을 전달한다.
    ...
    //             {/* < Nav  ></Nav> */}
    //             {/*  MainBody  컴포넌트는 reids 서버 켜야해서 잠시 삭제함 */}
    //             <Header match={ismatch}  ></Header>
    //             {/* <MainHomeBody />
    // <Footer/> */}
