...
app.use(cors({ origin: ['http://localhost:3000','https://calm-shortbread-d2aa50.netlify.app','http://calm-shortbread-d2aa50.netlify.app','http://'+`${process.env.REACT_APP_SMARTPHONE_IP}`+':3000'], credentials: true }));
